...
ObstacleAvoider::ObstacleAvoider(const std::string& cmd_vel_topic, 
                                 const std::string& left_sensor_topic, 
                                 const std::string& right_sensor_topic) : Node("obstacle_avoider") {
...
int main(int argc, char *argv[]) {
  ...
  // rclcpp::spin(avoider);
  auto avoider1 = std::make_shared<ObstacleAvoider>("/cmd_vel", "/my_robot1/left_sensor", "/my_robot1/right_sensor");
  auto avoider2 = std::make_shared<ObstacleAvoider>("/cmd_vel", "/my_robot2/left_sensor", "/my_robot2/right_sensor");

  rclcpp::spin(avoider1);
  rclcpp::spin(avoider2);
