...
public:
  ...
  : Node("node_with_parameters")
  {
    ...
    // adding my_parameter from the package cpp_parameters
    // https://docs.ros.org/en/iron/Tutorials/Beginner-Client-Libraries/Using-Parameters-In-A-Class-CPP.html
    ...
    auto remote_node_name1 = std::string("minimal_param_node");
    auto remote_param_name1 = std::string("my_parameter");
    cb_handle3_ = param_subscriber_->add_parameter_callback(remote_param_name1, cb3, remote_node_name1);
